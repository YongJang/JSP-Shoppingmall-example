...
$(window).ready(function() {
	...
	$.vegas('slideshow', {
	  backgrounds:[
		{ src:'../assets/bootstrap-3.3.5-dist/images/bg-slider/bg-1.jpg', fade:1000 },
		{ src:'../assets/bootstrap-3.3.5-dist/images/bg-slider/bg-2.jpg', fade:1000 },
		{ src:'../assets/bootstrap-3.3.5-dist/images/bg-slider/bg-3.jpg', fade:1000 }
	  ]
	})();
});
...
$(document).ready(function() {
	...
	$('form.contact-form').on('submit', function(e) {
		$.post('../BOARD/writePro.jsp', $(this).serialize(), function(response) {
